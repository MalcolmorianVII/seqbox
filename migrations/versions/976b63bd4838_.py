...
Revision ID: 976b63bd4838
Revises: 84a3c58d3a80
Create Date: 2022-07-05 11:45:02.798458
...
revision = '976b63bd4838'
down_revision = '84a3c58d3a80'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['groups_id'], ['groups.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['raw_sequencing_batch_id'], ['raw_sequencing_batch.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('date_collected', sa.DateTime(), nullable=True, comment='DMY sample was collected'),
    ...
    sa.Column('date_received', sa.DateTime(), nullable=True, comment='DMY the sample was received'),
    sa.Column('date_added', sa.DateTime(), nullable=True),
    sa.Column('processing_institution', sa.VARCHAR(length=60), nullable=True, comment='The institution which processed the sample.'),
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['sample_source_id'], ['sample_source.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['pcr_assay_id'], ['pcr_assay.id'], onupdate='cascade', ondelete='cascade'),
    sa.ForeignKeyConstraint(['sample_id'], ['sample.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('pcr_identifier', sa.Integer(), nullable=True, comment='Differentiates this PCR from other PCRs done on this sample on the same day.'),
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['extraction_id'], ['extraction.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('date_pcred', sa.DateTime(), nullable=True, comment='Date this PCR was done'),
    sa.Column('date_added', sa.DateTime(), nullable=True),
    sa.Column('protocol', sa.VARCHAR(length=60), nullable=True, comment='Tiling PCR protocol'),
    sa.Column('pcr_identifier', sa.Integer(), nullable=True, comment='Differentiates this PCR from other PCRs done on this sample on the same day.'),
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['extraction_id'], ['extraction.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.ForeignKeyConstraint(['extraction_id'], ['extraction.id'], onupdate='cascade', ondelete='cascade'),
    sa.ForeignKeyConstraint(['raw_sequencing_batch_id'], ['raw_sequencing_batch.id'], onupdate='cascade', ondelete='cascade'),
    sa.ForeignKeyConstraint(['tiling_pcr_id'], ['tiling_pcr.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['raw_sequencing_id'], ['raw_sequencing.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['raw_sequencing_id'], ['raw_sequencing.id'], onupdate='cascade', ondelete='cascade'),
    sa.ForeignKeyConstraint(['readset_batch_id'], ['read_set_batch.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('notes', sa.VARCHAR(length=256), nullable=True, comment='General comments.'),
    sa.ForeignKeyConstraint(['readset_id'], ['read_set.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('pangolearn_version', sa.DateTime(), nullable=True, comment='Pangolearn version'),
    ...
    sa.ForeignKeyConstraint(['artic_covid_result_id'], ['artic_covid_result.id'], onupdate='cascade', ondelete='cascade'),
    sa.PrimaryKeyConstraint('id')
    )
