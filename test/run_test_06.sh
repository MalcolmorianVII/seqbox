...
python3 ../src/scripts/seqbox_cmd.py add_readsets -i 06.test/nanopore_default_readsets.csv -n
python3 ../src/scripts/seqbox_filehandling.py add_readset_to_filestructure -i 06.test/nanopore_default_readsets.csv -c test_seqbox_config.yaml -n
