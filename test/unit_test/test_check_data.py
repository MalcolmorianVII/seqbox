...
# test_check_info(check_cultures_test_data, cultures_info_valid_keys)
test_check_info(check_extraction_fields_test_data, extraction_info_valid_keys)
test_check_info(check_group_test_data, group_info_valid_keys)

test_check_info(check_mykrobe_res_test_data, mykrobe_res_info_valid_keys)
test_check_info(check_pangolin_result_test_data, pangolin_result_info_valid_keys)
test_check_info(check_pcr_result_test_data, pcr_result_info_valid_keys)
test_check_info(check_project_test_data, project_info_valid_keys)
test_check_info(check_raw_sequencing_batch_test_data, raw_sequencing_batch_info_valid_keys)

test_check_info(check_readset_batches_test_data, readset_batch_info_valid_keys)
test_check_info(check_readset_fields_test_data, readset_info_valid_keys)
test_check_info(check_sample_source_associated_with_project_test_data, sample_source_info_with_project_valid_keys)
test_check_info(check_sample_sources_test_data, sample_source_info_valid_keys)

test_check_info(check_samples_test_data, sample_info_valid_keys)
test_check_info(check_tiling_pcr_test_data, tiling_pcr_info_valid_keys)
