...
python3 ../src/scripts/seqbox_cmd.py add_pcr_results -i 01.test_todo_list_query/pcr_results.csv
...
python3 ../src/scripts/seqbox_cmd.py add_artic_covid_results -i 01.test_todo_list_query/artic_nf_covid_results.csv -b 20201201_1355_MN33881_FAO20804_109641e0 -w medaka -p docker
python3 ../src/scripts/seqbox_cmd.py add_pangolin_results -i 01.test_todo_list_query/pangolin_results.csv -b 20201201_1355_MN33881_FAO20804_109641e0 -w medaka -p docker
